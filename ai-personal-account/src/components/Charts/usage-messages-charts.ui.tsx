...
import { useGetUsageMessageQuery } from '../../services/usage.service';
    ...
    >
      ...
      >
        ...
        >
          ...
          {(() => {
            const usageArr = Array.isArray(messagesData?.data)
              ? messagesData.data
              : [];
            ...
            const input = usageArr.map((item) => item.n);
            ...
            return (
              <BarChart
                ...
                yAxis={[{ position: 'none' }]}
                series={[{ data: input, label: t('input'), stack: 'assets' }]}
                borderRadius={6}
                sx={{
